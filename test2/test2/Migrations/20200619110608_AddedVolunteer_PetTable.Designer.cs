...
namespace test2.Migrations
{
    ...
    [Migration("20200619110608_AddedVolunteer_PetTable")]
    partial class AddedVolunteer_PetTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("test2.Models.Volunteer_Pet", b =>
                {
                    b.HasOne("test2.Models.Pet", "IdPetNavigation")
                        .WithMany()
                        .HasForeignKey("IdPet")
                        .HasConstraintName("IdPet")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("test2.Models.Volunteer", "IdVolunteerNavigation")
                        .WithMany()
                        .HasForeignKey("IdVolunteer")
                        .HasConstraintName("IdVolunteer")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
